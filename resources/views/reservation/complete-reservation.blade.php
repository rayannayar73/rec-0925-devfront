...
<div class="container mx-auto px-20 py-8">
    ...
    <div class="flex gap-8 h-[calc(100vh-200px)]">
        ...
        <div class="flex-1 overflow-y-auto pr-8" style="height: fit-content;">
            <!-- Alert Banner -->
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4">
                    <div>
                        <input type="text" placeholder="Nom Prénom" class="w-full px-4 py-3 border border-gray-300 bg-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-semibold">
                    </div>
                    <div>
                        <input type="email" placeholder="Email" class="w-full px-4 py-3 border border-gray-300 bg-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-semibold">
                    </div>
                    <div>
                        <input type="tel" placeholder="Numéro de téléphone" class="w-full px-4 py-3 border border-gray-300 bg-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-semibold">
                    </div>
                </div>
            </div>
            ...
            <div class="py-8">
                <h2 class="text-xl font-bold text-gray-800">Choisissez votre moyen de paiement</h2>
                <p class="text-gray-800 font-bold mb-4 flex items-center gap-2">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/MasterCard_Logo.svg/2560px-MasterCard_Logo.svg.png" alt="Credit Card" class="h-8">
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div class="flex items-center gap-3">
                            <input type="radio" name="payment" class="w-4 h-4 text-blue-600">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Apple_Pay_logo.svg/2560px-Apple_Pay_logo.svg.png" alt="Apple Pay" class="h-8">
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div class="flex items-center gap-3">
                            <input type="radio" name="payment" class="w-4 h-4 text-blue-600">
                            <img src="https://upload.wikimedia.org/wikipedia/fr/thumb/5/5b/Alma_Logo.svg/2560px-Alma_Logo.svg.png" alt="Alma" class="h-8">
                            <span class="font-semibold">Alma</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Submit Button -->
            <button class="w-full bg-[#C8286C] text-white py-4 rounded-lg font-bold hover:bg-[#A62259] transition-colors">
