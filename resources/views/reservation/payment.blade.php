...
<div class="container mx-auto px-20 py-8">
    <h1 class="text-[32px] font-semibold text-gray-800 mb-4">Confirmer et payer</h1>
    ...
    <div class="flex gap-8">
        ...
        <div class="flex-1 overflow-y-auto pr-18" style="height: fit-content;">
            ...
            <div class="rounded-lg p-4 mb-8 flex items-start gap-3 border border-gray-200">
                ...
                <div>
                    <div class="text-xl font-medium text-gray-900">Date de réservation en forte demande</div>
                    <div class="text-xl font-medium text-gray-900">Les réservations sont fréquentes pour ce centre</div>
                </div>
            </div>
            ...
            <div class="py-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-semibold text-2xl">Date</div>
                            <div class="text-gray-600 font-medium text-xl">12 mai 2025</div>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <svg class="w-8 h-8 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <div class="font-semibold text-2xl">Horaire</div>
                            <div class="text-gray-600 font-medium text-xl">12:30</div>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <svg class="w-8 h-8 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <div class="font-semibold text-2xl">Adresse</div>
                            <div class="text-gray-600 font-medium text-xl">39 Rue Emile Steiner, 27200 Vernon</div>
                        </div>
                    </div>
                </div>
            </div>
